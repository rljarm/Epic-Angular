...
.config(function($stateProvider, $urlRouterProvider){
  ...
  .state('vineyards.list', {url: '/', templateUrl: '/views/vineyards/vineyards-list.html', controller: 'VineyardsListCtrl'})
  .state('vineyards.new', {url: '/new', templateUrl: '/views/vineyards/vineyards-new.html', controller: 'VineyardsNewCtrl'})
  .state('vineyards.show', {url: '/show', templateUrl: '/views/vineyards/vineyards-show.html', controller: 'VineyardsShowCtrl'})
  ...
  .state('hotels.show', {url: '/show', templateUrl: '/views/hotels/hotels-show.html', controller: 'HotelsShowCtrl'});
});
